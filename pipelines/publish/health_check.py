...
"""Health check module for knowledge integration.

This module provides tools to verify the integrity and performance of the
knowledge base, including FAISS index hash verification, database record counts,
and search latency benchmarking using golden queries.
"""
...
def run_health_check():
    """Executes a comprehensive health check of the knowledge integration system.

    This function performs the following checks:
    1. Verifies the integrity of the FAISS index and KNDB files against the manifest.
    2. Ensures the vector count in the FAISS index matches the metadata records.
    3. Benchmarks search latency using a set of golden queries.
    4. Generates a health report and saves it to a JSON file.

    Returns:
        bool: True if all health checks pass and no critical errors are found,
            False otherwise.
    """
