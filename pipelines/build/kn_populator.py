...
Usage:
    python pipelines/build/kn_populator.py \
...
class KNBinaryWriter:
    ...
    def __init__(self, path: str | Path):
        """Initializes the KNBinaryWriter.

        Args:
            path: Path to the .kndb file.
        """
    ...
    def _load_max_id(self) -> None:
        """Loads the maximum node ID from the existing binary file to determine the next ID."""
...
class MetadataDB:
    ...
    def insert(self, id: int, key: str, question: str, answer: str,
        ...
        Args:
            ...
            row_index: Index in the source dataset.
        """
        self.conn.execute("""
    ...
    def stats(self) -> Dict[str, Any]:
        """Returns statistics about the metadata database.

        Returns:
            A dictionary containing total count, unique categories, and unique sources.
        """
...
class KNPopulator:
    ...
    def __init__(
        ...
        Args:
            kn_path: Path to the KNDatabase file.
    ...
    def stats(self) -> Dict[str, Any]:
        """Returns statistics for the populator, combining metadata, KN, and FAISS stats.

        Returns:
            A dictionary containing size and count information.
        """
...
if __name__ == "__main__":
    ...
    from pipelines.ingest.kaggle_loader import load_all_datasets
    from pipelines.build.swarm_embedder import SwarmEmbedder
