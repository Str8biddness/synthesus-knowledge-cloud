...
class SwarmEmbedder:
    ...
    def __init__(
        ...
        Args:
            ...
            min_dim:   Minimum output dimension enforced regardless of corpus size.
                       Prevents embedding collapse on very small datasets (default: 4).
        """
        self.dim = dim
    ...
    def _fit(self, corpus: list[str]) -> None:
        ...
        if actual_dim < self.min_dim:
            actual_dim = self.min_dim
        if actual_dim < 1:
            actual_dim = 1
