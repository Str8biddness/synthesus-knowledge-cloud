...
def main():
    """Main entry point for Lore Forge.

    Orchestrates the generation of synthetic lore nodes, upserts them into
    the Knowledge Cloud, generates and saves the transition graph for the
    SequenceLinker, and rebuilds the semantic search index.
    """
